      ...
      <Stack.Navigator initialRouteName="Login">
        <Stack.Screen 
          ...
          options={{ 
            ...
            header: () => <CustomHeader title="Login" onNext={undefined} onPrevious={undefined} /> // Add custom header
          }} 
        />
        <Stack.Screen 
          name="Hike" 
          ...
          options={{ 
            ...
            header: () => <CustomHeader title="Hike" onNext={undefined} onPrevious={undefined} /> // Add custom header
          }} 
        />
        <Stack.Screen 
          name="Info" 
          ...
          options={{ 
            headerShown: true, // Hide default header
            header: () => <CustomHeader title="Info" onNext={undefined} onPrevious={undefined} /> // Add custom header
          }} 
        />
      </Stack.Navigator>
    </NavigationContainer>
